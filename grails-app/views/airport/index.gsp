		...
		<div id="list-airport" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="code" title="${message(code: 'airport.code.label', default: 'Code')}" />
					
						<th><g:message code="airport.city.label" default="City" /></th>
				...
				<g:each in="${airportInstanceList}" status="i" var="airportInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${airportInstance.id}">${fieldValue(bean: airportInstance, field: "code")}</g:link></td>
			...
			<div class="pagination">
				<g:paginate total="${airportInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
